...
Créez un nouveau fichier slt_file_uploader_app.py Copiez les lignes de code suivantes dans votre fichier slt_file_uploader_app.py:  
...
```
streamlit run slt_file_uploader_app.py
```
...
```
git status
git add slt_file_uploader_app.py
